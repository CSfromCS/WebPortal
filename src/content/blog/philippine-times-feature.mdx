---
title: "700 rejections inspired a top graduate to become a Microsoft Software Engineer"
date: 2025-03-01
description: "A newspaper feature on my journey. Written by JM Callao for The Philippine Times, March 2025 Edition."
tags: ["career", "featured", "press"]
---
...
<img src="/images/NewspaperFeature2025Cropped.jpg" alt="The Philippine Times newspaper feature, March 2025" class="rounded-lg my-8 w-full" />
...
<img src="/images/NewspaperFeature2025.png" alt="The Philippine Times newspaper feature, March 2025 — clean scan" class="rounded-lg my-8 w-full" />

<a
  href="https://www.linkedin.com/posts/csfromcs_microsoft-softwareengineer-techjourney-activity-7311160097613778945-bPo4/"
  target="_blank"
  rel="noopener noreferrer"
  aria-label="View LinkedIn post (opens in a new tab)"
  class="group mt-4 inline-flex items-center gap-2 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)]/45 px-4 py-2 text-sm font-medium leading-none text-[var(--color-text-secondary)] no-underline transition-all duration-300 hover:-translate-y-0.5 hover:border-[var(--color-accent)] hover:bg-[var(--color-surface)] hover:text-[var(--color-accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bg)]"
>
  ...
  <span class="leading-none">View LinkedIn Post</span>
  <span aria-hidden="true" class="shrink-0 text-xs leading-none transition-transform duration-300 group-hover:translate-x-0.5">↗</span>
</a>
